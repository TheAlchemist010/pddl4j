...
{if ("" != null) return this.problem;}
  ...
  public ParsedProblem problemWithoutGoal() throws ParseException {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case LEFT_BRACKET:{
        pddl_problem_without_goal();
        break;
        }
      default:
        jj_la1[37] = jj_gen;
...
{if ("" != null) return this.problem;}
    ...
    final public ParsedProblem pddl_problem_without_goal() throws ParseException {Symbol<String> name;
        Symbol<String> domain;
    try {
      jj_consume_token(LEFT_BRACKET);
      jj_consume_token(DEFINE);
...
{if ("" != null) return this.problem;}
  ...
  final public ParsedProblem goalOnly() throws ParseException {
    Symbol<String> name;
    Symbol<String> domain;
    try {
    jj_consume_token(LEFT_BRACKET);
